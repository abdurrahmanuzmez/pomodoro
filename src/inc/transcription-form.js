...
*/
    changeHandler = (e) => {
        this.setState({[e.target.name]: document.getElementById("transcInput").innerText })
            ...
            <div>
                <div className="form">
                    <form className="input-wrapper" onSubmit={this.submitHandler}>
                        <input id="transcInput"
                               className="input transcInput"
                               type="text" placeholder="Text here..."
                               name="text"
                               value={product_name}
                               onChange={this.changeHandler}/>
                        <input id="transcTimeInput"
                               className="input transcInput"
                               type="number" placeholder="Time here (minute)"
                               name="time"
                               value={product_price}
                               onChange={this.changeHandler}/>
                    </form>
